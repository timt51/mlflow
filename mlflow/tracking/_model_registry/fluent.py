...
def register_model(
    model_uri, name, await_registration_for=DEFAULT_AWAIT_MAX_SLEEP_SECONDS, tags: Optional[Dict[str, Any]] = None
) -> ModelVersion:
    """
    ...
    if RunsArtifactRepository.is_runs_uri(model_uri):
        ...
        create_version_response = client.create_model_version(
            name, source=model_uri, run_id=None, tags=tags, await_creation_for=await_registration_for
        )
    eprint(
